...
$cheminFichierPathTableur = "A:\PS_ANA-Logs\config\Variables\Tableur\${env:USERNAME}_${env:COMPUTERNAME}.csv"
...
$cheminFichierLog = "A:\PS_ANA-Logs\log\logs.xlsx"

# Répertoire de destination
$destination = "A:\PS_ANA-Logs\log\ConsultationLogs"
