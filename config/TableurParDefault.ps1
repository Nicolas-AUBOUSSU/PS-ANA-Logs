...
$variablesDir = "A:\PS_ANA-Logs\config\Variables\Tableur"
...
$btnRunCode.Add_Click({
    ...
    $PathTableur = "A:\PS_ANA-Logs\OpenSoftwareCenter\LibreOfficePortable\LibreOfficeCalcPortable.exe"
...
& "A:\PS_ANA-Logs\config\FormMessageTermine.ps1"
