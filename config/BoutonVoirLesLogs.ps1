...
$cheminFichierCSV = "A:\PS_ANA-Logs\config\Variables\Tableur\${env:USERNAME}_${env:COMPUTERNAME}.csv"

# Chemin du script TableurParDefault.ps1
$cheminScriptTableur = "A:\PS_ANA-Logs\config\TableurParDefault.ps1"
...
if (Test-Path $cheminFichierCSV) {
    ...
    Invoke-Expression -Command $cheminScriptTableur
      ...
      Start-Process powershell.exe -ArgumentList "-NoExit", "-ExecutionPolicy Bypass", "-File A:\PS_ANA-Logs\config\LogsVoir.ps1"
