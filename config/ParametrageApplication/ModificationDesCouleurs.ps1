...
$colorBackground = Get-Content -Path "A:\PS_ANA-Logs\config\Variables\Color\Colorbackground.csv"

# Chargement de la couleur à partir du fichier CSV pour ColorBoutonbackground
$colorBoutonBackground = Get-Content -Path "A:\PS_ANA-Logs\config\Variables\Color\ColorBoutonbackground.csv"

# Chargement de la couleur à partir du fichier CSV pour ColorBoutonTexte
$colorBoutonTexte = Get-Content -Path "A:\PS_ANA-Logs\config\Variables\Color\ColorBoutonTexte.csv"

# Chargement de la couleur à partir du fichier CSV pour ColorBoutonTexteSurvol
$colorBoutonTexteSurvol = Get-Content -Path "A:\PS_ANA-Logs\config\Variables\Color\ColorBoutonTexteSurvol.csv"

# Chargement de la couleur à partir du fichier CSV pour ColorTitreBarreDeRecherche
$colorTitreBarreDeRecherche = Get-Content -Path "A:\PS_ANA-Logs\config\Variables\Color\ColorTitreBarreDeRecherche.csv"

# Chargement de la couleur à partir du fichier CSV pour ColorBoutonbackgroundSurvol
$ColorBoutonbackgroundSurvol = Get-Content -Path "A:\PS_ANA-Logs\config\Variables\Color\ColorBoutonbackgroundSurvol.csv"
...
function Select-Color {
    ...
    if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
        ...
        $formattedColor | Out-File -FilePath "A:\PS_ANA-Logs\config\Variables\Color\$colorName.csv" -Force
